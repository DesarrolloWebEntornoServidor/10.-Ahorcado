...
/*
		String palabraOculta = generaPalabra(arrayPalabras);
		out.println("Palabra: " + palabraOculta + " <br />");
		String palabraOcultaLimpia = limpiaPalabraOcultaOriginal(palabraOculta);
		out.println("Palabra limpia: " + palabraOcultaLimpia + " <br />");
		String palabraResuelta = generaPalabraResuelta(palabraOculta);
		out.println("Palabra cifrada: " + palabraResuelta + " <br />");
		out.println("Número máximo de fallos permitidos: " + INTENTOS_MAXIMOS + " <br />");
		out.println(generaCeldas(palabraResuelta));
*/		
		
		// out.println("palabraResuelta = #" + palabraResuelta + "#" + " <br /> \n");
		String codigoCeldas = generaCeldas(palabraResuelta);
		String textoMensajes = generaTextoMensajes(mensajes);
		String paginaHTML = generaPaginaHTML(textoMensajes, mensajeInicial, codigoCeldas, accion,
								palabraOcultaOriginal, palabraOculta, letraRecibida, letrasProbadas,
								numeroIntentosRestantes, estiloDivLetra); 

		out.println(paginaHTML);
	}
	...
	// generación de la página HTML de salida
	private String generaPaginaHTML(String textoMensajes, String mensajeInicial, String codigoCeldas,
							String accion, String palabraOcultaOriginal, String palabraOculta, String letraRecibida, 
							String letrasProbadas, int numeroIntentosRestantes, String estiloDivLetra) {
	  String salida = "";
	  salida = "<html> " + " \n"
